...
@Database(
    entities = [GifPreview::class, GifPreviewRemoteKeys::class, GifInfo::class],
    version = 1,
    exportSchema = false
)
@TypeConverters(Converters::class)
abstract class GiphyMeDatabase : RoomDatabase() {
    abstract fun getGifPreviewDao(): GifPreviewDao
    abstract fun getGifInfoRemoteKeysDao(): GifInfoRemoteKeysDao
    abstract fun gitGifInfoDao(): GifInfoDao
}